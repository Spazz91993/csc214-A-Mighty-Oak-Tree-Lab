...
public class App {
    public static void main(String[] args) {
        ...
        Node retrievedLeft = nodeOne.left();  // This retrieves the left child
        Node retrievedRight = nodeOne.right(); // This retrieves the right child

        System.out.println("Root node: " + nodeOne.getData().getName());
